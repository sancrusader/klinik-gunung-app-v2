            ...
            <div class="px-4 pt-6">
                <div class="grid gap-4 xl:grid-cols-2 2xl:grid-cols-3">
                    ...
                    <div
                        ...
                        <h3 class="flex items-center mb-4 text-lg font-semibold text-gray-900 dark:text-white">Last User
                                            ...
                                            <div class="flex items-center space-x-4">
                                                <div class="flex-shrink-0">
                                                    <img class="w-8 h-8 rounded-full"
                                                        src="{{ $user->getProfilePhotoUrl() }}" alt="Neil image">
                                                </div>
                        ...
                        <ol class="relative border-l border-gray-200 dark:border-gray-700">
                            <li class="mb-10 ml-4">
                                ...
                                <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Get access to
                                    over
                                    20+ pages including a dashboard layout, charts, kanban board, calendar, and
                                    pre-order
                            ...
                            <div class="relative mx-auto overflow-hidden h-[36rem] lg:h-[24rem]">
                                <div class="hidden duration-700 ease-in-out bg-white dark:bg-gray-800"
                                    ...
                                    <p class="mb-4 text-gray-500 dark:text-gray-400">Get started with a free and
                                        ...
                                        featuring
                                        charts, widgets, CRUD layouts, authentication pages, and more</p>

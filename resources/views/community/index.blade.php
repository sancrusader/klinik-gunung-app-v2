            ...
            <div
                ...
                <div class="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
                    <div class="p-4 mb-4 bg-white sm:p-6 dark:border-gray-700 dark:bg-gray-800  xl:mb-0">
                        <!-- Chat -->
                        <form class="overflow-y-auto h2xl:max-h-fit">
                            @foreach ($topics as $topic)
                                <article class="mb-5 border-b border:gray-100 dark:border-gray-600">
                                    ...
                                    <a href="{{ route('community.show', $topic->id) }}"
                                        class="mb-4 inline-flex items-center text-xs font-medium text-primary-700 sm:text-sm dark:text-primary-500">

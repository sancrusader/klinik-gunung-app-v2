        ...
        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        <a href="{{ route('koordinator.manajemen') }}"
                            class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                            ...
                            <span class="ml-3" sidebar-toggle-item>Manajemen Darurat</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('koordinator.report') }}"
                            class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                            <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                fill="#6b7280" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <li>
                        <a href="{{ route('community.index') }}"
                            ...
                            <span class="ml-3" sidebar-toggle-item>Community</span>
                        </a>
                    </li>
                </ul>
            </div>

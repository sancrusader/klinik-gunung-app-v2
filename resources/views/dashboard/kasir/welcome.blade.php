<x-dashboard.dashboard-layout>
    ...
    <div id="main-content" class="relative w-full h-full overflow-y-auto bg-gray-50 lg:ml-64 dark:bg-gray-900">
        <main>
            <div class="px-4 pt-6">
                <div
                    class="mb-4 w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="flex justify-between">
                        <div>
                            <h5 class="leading-none text-3xl font-bold text-gray-900 dark:text-white pb-2">
                                RP.{{ number_format($totalPaymentsThisWeek, 2) }}</h5>
                            <p class="text-base font-normal text-gray-500 dark:text-gray-400">Pemasukan Minggu Ini</p>
                        </div>
                        <div

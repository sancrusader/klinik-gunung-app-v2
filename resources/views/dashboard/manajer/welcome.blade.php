    ...
    <div id="main-content" class="relative w-full h-full overflow-y-auto bg-gray-50 lg:ml-64 dark:bg-gray-900">
        <main>
                    ...
                    <div class="items-center sm:flex">
                        <div class="flex items-center">
                            ...
                            <div id="dropdown" class="z-10 hidden w-56 p-3 bg-white rounded-lg shadow dark:bg-gray-700"
                                ...
                                style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(920.5px, 3259.5px, 0px);">
                ...
                <div class="flex items-center justify-between pt-3 sm:pt-6">
                    <div>
                        ...
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                            ...
                            style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(355px, 3006.5px, 0px);">
            ...
            {{-- <div class="px-4 pt-6">
                ...
                <ul>
                    <li><a href="{{ route('manajer.schedule.form') }}">Kelola Jadwal Staf</a></li>
                    <li><a href="{{ route('manajer.reports') }}">Lihat Laporan</a></li>
                </ul> --}}
</x-dashboard.dashboard-layout>

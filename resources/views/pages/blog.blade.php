                ...
                <div class="grid gap-8 lg:grid-cols-2">
                    @foreach ($posts as $post)
                        <article
                            ...
                            {{-- Konten --}}
                            <p class="mb-5 font-light text-gray-500 dark:text-gray-400">{!! \Illuminate\Support\Str::limit($post->content, 100) !!}</p>
                            <div class="flex justify-between items-center">
                                <div class="flex items-center space-x-4">
                                    <img class="w-7 h-7 rounded-full" src="{{ asset('assets/logo/kg.png') }}"

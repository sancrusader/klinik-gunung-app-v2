...
@if ($post->author_name)
    <div class="author-info" style="margin-top: 10px;">
        @if ($post->author_profile_picture)
            <img src="{{ Storage::url($post->author_profile_picture) }}" alt="Author Profile Picture" width="50"
                ...
                <header class="mb-4 lg:mb-6 not-format">
                    <address class="flex items-center mb-6 not-italic">
                        <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                            ...
                            <div>
                                <a href="#" rel="author"
                                    class="text-xl font-bold text-gray-900 dark:text-white">{{ $post->author_name }}</a>
